      ...
      <div className="container mx-auto max-w-4xl px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-300">
            Have questions, feedback, or suggestions? We are here to listen.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-md flex flex-col items-center rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-8 md:p-10 text-center shadow-2xl transition-transform hover:scale-[1.01] duration-300">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              For personal inquiries, collaborations, or business matters,
              please contact me directly via Discord.
            </p>
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                {copied ? "Copied Successfully!" : "Copy Username"}
              </button>
            </div>
          </div>
        </div>

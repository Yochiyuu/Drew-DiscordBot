...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-center w-full min-h-[calc(100vh-4rem)]">
      <div className="absolute inset-0 -z-10 h-full w-full bg-black bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(37,99,235,0.25),rgba(255,255,255,0))]"></div>
      ...
      <div className="container mx-auto max-w-4xl text-center px-6">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="#commands"
            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-md border border-gray-800 bg-transparent px-8 text-sm font-medium text-gray-300 shadow-sm transition-colors hover:bg-gray-800 sm:w-auto"
          >
            <Terminal size={18} />
            Command
          </Link>
